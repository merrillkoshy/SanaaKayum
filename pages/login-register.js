...
import { loadCompare } from "../redux/actions/compareActions";
...
const LoginRegister = ({
  ...
  const checkUser = (eve, username, password) => {
    eve.preventDefault();
                            ...
                            <form>
                              ...
                              <div className="button-box">
                                <div className="login-toggle-btn">
                                  ...
                                  <a href={process.env.RAZZLE_PUBLIC_URL + "/"}>
                                    Forgot Password?
                                  </a>
                                </div>
                                <button
                          ...
                          <div className="login-register-form">
                            <Form noValidate validated={validated}>
                              <Form.Row className={"mb-3"}>
                                ...
                                <p>
                                  Join us and keep track of your orders. Share
                                  your contact information so that we can assist
                                  you better at delivering your products.
                                </p>
                              </Form.Row>
                              <Form.Row>
                                <Form.Group
                              ...
                              <Form.Row>
                                ...
                                atleast one uppercase, one lowercase and a number"
                                  ...
                                  <Form.Control.Feedback type="invalid">
                                    Password should contain atleast eight
                                    characters of atleast one uppercase, one
                                    lowercase and a number. Please do not put
