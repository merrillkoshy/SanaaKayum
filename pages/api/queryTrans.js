...
export default async function handler(req, res) {
  const queryData = req.body.check;
  ...
  if (req.method === "POST") {
    ...
    axios
      ...
      .then(response => {
        ...
        const address =
          response.data.customer_details.street1 +
          "\n" +
        ...
        const phone = response.data.customer_details?.phone
