...
const TncCtn = ({ spaceTopClass, spaceBottomClass }) => {
  return (
    <div
    ...
    >
      <div className="container">
        <div className="welcome-content text-center">
          ...
          <h5>
            <strong>Updated: August 8, 2020</strong>
          </h5>

          <p className="text-justify">
            Welcome to Haute Couture &amp; High-Street Fashion - Sana'a Kayum!
          </p>

          <p className="text-justify">
            These terms and conditions outline the rules and regulations for the
            use of SANAA KAYUM CLOTHING ART LLC's Website, located at
            https://sanaakayum.com.
          </p>

          <p className="text-justify">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Haute Couture &amp; High-Street
            Fashion - Sana'a Kayum if you do not agree to take all of the terms
          ...
          <p className="text-justify">
            We employ the use of cookies. By accessing Haute Couture &amp;
            High-Street Fashion - Sana'a Kayum, you agreed to use cookies in
            agreement with the SANAA KAYUM CLOTHING ART LLC's Privacy Policy.
          </p>
          ...
          <p className="text-justify">
            Unless otherwise stated, SANAA KAYUM CLOTHING ART LLC and/or its
            licensors own the intellectual property rights for all material on
            Haute Couture &amp; High-Street Fashion - Sana'a Kayum. All
            intellectual property rights are reserved. You may access this from
            Haute Couture &amp; High-Street Fashion - Sana'a Kayum for your own
          ...
          <p className="text-justify">
            ...
            <ol>
              <li>
                Republish material from Haute Couture &amp; High-Street Fashion
                - Sana'a Kayum
              </li>
              <li>
                Sell, rent or sub-license material from Haute Couture &amp;
                High-Street Fashion - Sana'a Kayum
              </li>
              <li>
                Reproduce, duplicate or copy material from Haute Couture &amp;
                High-Street Fashion - Sana'a Kayum
              </li>
              <li>
                Redistribute content from Haute Couture &amp; High-Street
                Fashion - Sana'a Kayum
              </li>
            </ol>
          </p>
          <p className="text-justify">
          ...
          <p className="text-justify">
            ...
            SANAA KAYUM CLOTHING ART LLC does not filter, edit, publish or
            review Comments prior to their presence on the website. Comments do
            not reflect the views and opinions of SANAA KAYUM CLOTHING ART
            ...
            extent permitted by applicable laws, SANAA KAYUM CLOTHING ART LLC
          ...
          <p className="text-justify">
            SANAA KAYUM CLOTHING ART LLC reserves the right to monitor all
          ...
          <p className="text-justify">
            You hereby grant SANAA KAYUM CLOTHING ART LLC a non-exclusive
          ...
          <p className="text-justify">
            ...
            visibility of the hyperlink compensates the absence of SANAA KAYUM
            CLOTHING ART LLC; and (d) the link is in the context of general
          ...
          <p className="text-justify">
            ...
            sending an e-mail to SANAA KAYUM CLOTHING ART LLC. Please include
          ...
          <p className="text-justify">
            No use of SANAA KAYUM CLOTHING ART LLC's logo or other artwork will
